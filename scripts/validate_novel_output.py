...
survive prose-only instructions: TXT blank lines, paragraph density, reflective
endings, short atmosphere endings, and stale planning fields that push chapters
back into container-like summaries.
"""
...
def main() -> int:
    ...
    for chapter in chapters:
        issues.extend(validate_txt(project / "chapters" / chapter / "final.txt", args.fix_format))
